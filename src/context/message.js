...
const messageReducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case "SET_USER_MESSAGES":
      ...
      userIndex = usersCopy.findIndex((u) => u.username === username.username);
      console.log("4444444444", userIndex);
    ...
    case "SET_SELECTED_USER":
      usersCopy = state.users.map((user) => ({
        ...user,
        selected: user._id === action.payload,
      }));
    ...
    case "ADD_MESSAGE":
      ...
      console.log("fdfsdfdsfsdfdsfsdf", username);

      userIndex = usersCopy.findIndex((u) => u._id === username);
      console.log("fsdfsdfdsfsdfewrwerfgdasf", usersCopy[userIndex].messages);
      message.reactions = [];
